...
import com.jash.himalayademo.databinding.AlbumItemBinding;
import com.jash.himalayademo.fragments.AlbumFragment;
...
public class AlbumEntity {
    ...
    public void click(View view){
        AlbumItemBinding binding = DataBindingUtil.getBinding(view);

        AlbumFragment fragment = AlbumFragment.newInstance(albumId);

        ViewCompat.setTransitionName(binding.albumCover, title);
        FragmentTransaction transaction = ((FragmentActivity) view.getContext()).getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.content, fragment).addSharedElement(binding.albumCover, title).addToBackStack(null).commit();
